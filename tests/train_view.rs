...
async fn test_deserialize1_async() -> Result<(), septa_api::errors::Error> {
        ...
        [
            {
                ...
                "late":0,
                "SOURCE":"Norristown Transit Center",
                "TRACK":"",
                "TRACK_CHANGE":""
            },
            {
            ...
            },
            {
                ...
                "trainno":"3236",
                "service":"LOCAL",
                "dest":"Norristown Transit Center",
                "currentstop":"Suburban Station",
    ...
    assert_eq!(trains[0].source, RegionalRailStop::NorristownTransitCenter);
    ...
    assert_eq!(trains[2].dest, RegionalRailStop::NorristownTransitCenter);
